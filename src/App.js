...
let connectedUser, localConnection, dataChannel;

const Chat = ({ connection, updateConnection, channel, updateChannel }) => {
  // const localConnection = useContext(ConnectionContext);
  // const dataChannel = useContext(ChannelContext);
  ...
  const onOffer = ({ offer, name }) => {
    ...
    connectedUser = name;
    console.log({ connection, channel, updateChannel, updateConnection })
  ...
  const sendMsg = () => {
    ...
    let messages = messagesRef.current;
    let userMessages = messages[connectedUser];
    if (messages[connectedUser]) {
      userMessages = [...userMessages, text];
      let newMessages = Object.assign({}, messages, {
        [connectedUser]: userMessages
      });
      messagesRef.current = newMessages;
      setMessages(newMessages);
    } else {
      userMessages = Object.assign({}, messages, { [connectedUser]: [text] });
